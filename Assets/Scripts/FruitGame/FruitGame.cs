...
public class FruitGame : MonoBehaviour
{
    ...
    public float[] fruitSizes = { 0.5f, 0.7f, 0.9f, 1.1f, 1.3f, 1.4f, 1.7f, 1.9f };

    public GameObject currentFruit;
    public int currentFruitType;

    public float fruitStartHeight = 4.0f;
    ...
    void SpawnNewFruit()
    {
        if (!isGameOver)
        {
            ...
            if (fruitScript != null)
            {
                fruitScript.fruitType = currentFruitType;
            }
        }
    }
    ...
    public void MergeFruits(int fruitType, Vector3 position)
    {
        if (fruitType < fruitPrefabs.Length - 1)
        {
            ...
            if (fruitScript != null)
            {
                fruitScript.fruitType = fruitType + 1;
            }
        }
    }
    ...
    public void CheckGameOver()
    {
        ...
        for (int i = 0; allFruits.Length > i; i++)
        {
            if (allFruits[i] != null)
            {
